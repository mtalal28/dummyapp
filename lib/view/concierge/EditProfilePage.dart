...
import 'package:easyrsv/models/Profile_model.dart.dart';
            ...
            Padding(
              ...
              child: Container(
                ...
                child: _image != null
                    ? CircleAvatar(
                        radius: 50,
                        backgroundImage: FileImage(_image!), // Display the picked image
                      )
                    : widget.concierge['profile_picture'] != null
                        ? CircleAvatar(
                            radius: 50,
                            backgroundImage: NetworkImage(widget.concierge['profile_picture']),
                          )
                        : CircleAvatar(
                            radius: 50,
